...
radamsa -p output/id_%n -n 100 seedfile
The above cmd line generates 100 mutations at one time.
'''
...
input_path: "12h-cxxfilt-radamsa/outcomes-1/output"
err_path: "12h-cxxfilt-radamsa/outcomes-1/err"
'''
